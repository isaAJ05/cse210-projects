...
class Program
{
    static void Main(string[] args)
    {
        ...
        {
            case "1":
                BreathingActivity breathingActivity = new BreathingActivity("Breathing Activity", "Focus on your breathing", 5);
                breathingActivity.Run();
                break;
            case "2":
                // ReflectionActivity reflectionActivity = new ReflectionActivity("Reflection Activity", "Reflect on your day", 5);
                // reflectionActivity.Run();
                Console.WriteLine("Reflection Activity is not implemented yet.");
                break;
            case "3":
