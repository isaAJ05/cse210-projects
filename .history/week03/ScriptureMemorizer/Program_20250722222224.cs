...
It choose scriptures at random to present to the user. The file is called scriptures.txt. It uses setters to the reference (SetBook,SetChapter,Set)
...
class Program
{
    static void Main(string[] args)
    {
        ...
        {
            count += 1;// count the length of scriptures
        }
        Random random1 = new Random();
        Scripture scripture = new Scripture();
        scripture = _scriptures[random1.Next(0,count)];//select a random scripture from our list
