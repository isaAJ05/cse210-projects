...
class Program
{
    ...
    Comment comment21 = new Comment("Marquez", "Excellent video Pau!");
    ...
    Comment comment31 = new Comment("Will", "Excellent video Pau!");
    ...
    Comment comment41 = new Comment("Elias", "Excellent video Pau!");
    video4.AddComment(comment41);
    Comment comment42 = new Comment("Matt", "So Cool");
    video4.AddComment(comment42);
    Comment comment43 = new Comment("James", "Great!");
