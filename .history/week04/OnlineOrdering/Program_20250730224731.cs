...
class Program
{
    static void Main(string[] args)
    {
        ...
        Address _address2 = new Address("Street 5", "New York City", "New York", "USA");
        Customer _customer2 = new Customer("Luis Berrio", _address);
        List<Product> _products2 = new List<Product>();
        Product _product21 = new Product("Led", 104025, 20, 5);
        Product _product22 = new Product("Computer", 104026, 1000, 1);
        ...
        Order _order2 = new Order(_products2, _customer);
